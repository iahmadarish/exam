            ...
            <div className="flex justify-between py-[120px]">
                ...
                <div className="">
                    <div className="bg-slate-400 rounded-md absolute top-[40%]  right-80">
                        <img className='w-[350px]' src="https://static.vecteezy.com/system/resources/previews/021/096/518/original/3d-icon-digital-marketing-png.png" alt="" />
                    </div>
                    <div className="bg-slate-400 rounded-md absolute top-[20%]  right-20">
                        <img className='w-[350px]' src="https://static.vecteezy.com/system/resources/previews/011/019/166/non_2x/social-media-and-digital-marketing-3d-illustration-png.png" alt="" />
                    </div>
                </div>
            </div>
        </div>
