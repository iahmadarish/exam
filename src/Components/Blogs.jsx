...
import elment from "../../public/element.png"

const Blogs = () => {
    return (
        <div className='max-w-screen-xl mx-auto py-12'>
            <div className="max-w-screen-xl mx-auto">
                <img className='text-center mx-auto' src={elment} alt="" />
            ...
            <section className='flex mx-auto gap-x-5 '>
                <div className=" rounded-md shadow-md dark:bg-gray-50 dark:text-gray-800 mx-auto mt-6 mx-0">
                ...
                <div className="s rounded-md shadow-md dark:bg-gray-50 dark:text-gray-800 mx-auto mt-6 mx-0">
